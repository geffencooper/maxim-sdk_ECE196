...
#sudo ./openocd -f interface/cmsis-dap.cfg -f target/max78000.cfg -s ./scripts -c "program ../../Examples/MAX78000/Facial_Temperature_Scanner/build/max78000.elf verify reset exit"
